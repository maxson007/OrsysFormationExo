...
""" DOcumentation ContactMysql Agenda"""
class ContactMysqlDA():
    ...
    def __new__(cls, *args, **kwargs):
        if cls.instance is None:
            ...
            cls.instance.agendaDB = pymysql.connect(host="localhost", user="root", passwd="root",
                                                    db="ORSYS_FORMATION_PYTHON", cursorclass=pymysql.cursors.DictCursor)
        return cls.instance
